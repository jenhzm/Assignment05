...
#   <Jennifer Hernandez-Mora>,<05/29/2024>, <Edited Starter File>
# ------------------------------------------------------------------------------------------ #
import json
...
try:
    ...
    print("Error with reading the file") # changed
    print("Please check you have entered the correct json and that the file exists") #Changed
    print(e.__doc__)
    print(e.__str__())
finally:
